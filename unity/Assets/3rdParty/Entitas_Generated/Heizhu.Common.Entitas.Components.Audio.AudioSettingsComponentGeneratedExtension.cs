...
namespace Entitas {
    public partial class Entity {
        public Oultrox.Common.Entitas.Components.Audio.AudioSettingsComponent audioSettings { get { return (Oultrox.Common.Entitas.Components.Audio.AudioSettingsComponent)GetComponent(ComponentIds.AudioSettings); } }
        ...
        public Entity AddAudioSettings(bool newIsMuted) {
            var component = CreateComponent<Oultrox.Common.Entitas.Components.Audio.AudioSettingsComponent>(ComponentIds.AudioSettings);
    ...
    public partial class Pool {
        ...
        public Oultrox.Common.Entitas.Components.Audio.AudioSettingsComponent audioSettings { get { return audioSettingsEntity.audioSettings; } }

        public bool hasAudioSettings { get { return audioSettingsEntity != null; } }

        public Entity SetAudioSettings(bool newIsMuted) {
            if (hasAudioSettings) {
                throw new EntitasException("Could not set audioSettings!\n" + this + " already has an entity with Heizhu.Common.Entitas.Components.Audio.AudioSettingsComponent!",

...
namespace Entitas {
    public partial class Entity {
        static readonly Oultrox.Common.Entitas.Components.Destroy.DestroyComponent destroyComponent = new Oultrox.Common.Entitas.Components.Destroy.DestroyComponent();

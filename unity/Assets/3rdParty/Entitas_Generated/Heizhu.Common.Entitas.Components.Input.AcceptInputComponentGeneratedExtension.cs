...
namespace Entitas {
    public partial class Entity {
        static readonly Oultrox.Common.Entitas.Components.Input.AcceptInputComponent acceptInputComponent = new Oultrox.Common.Entitas.Components.Input.AcceptInputComponent();

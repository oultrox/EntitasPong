...
namespace Entitas {
    public partial class Entity {
        public Oultrox.Common.Entitas.Components.Transform.FrictionComponent friction { get { return (Oultrox.Common.Entitas.Components.Transform.FrictionComponent)GetComponent(ComponentIds.Friction); } }
        ...
        public Entity ReplaceFriction(Oultrox.Common.UnityEngineReplacement.Vector3 newFriction) {
            var component = CreateComponent<Oultrox.Common.Entitas.Components.Transform.FrictionComponent>(ComponentIds.Friction);
            component.friction = newFriction;

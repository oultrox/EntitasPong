...
namespace Entitas {
    public partial class Entity {
        public Oultrox.EntitasPong.Entitas.Components.GameState.BoundsComponent bounds { get { return (Oultrox.EntitasPong.Entitas.Components.GameState.BoundsComponent)GetComponent(ComponentIds.Bounds); } }
        ...
        public Entity ReplaceBounds(Oultrox.Common.UnityEngineReplacement.Bounds newBounds) {
            var component = CreateComponent<Oultrox.EntitasPong.Entitas.Components.GameState.BoundsComponent>(ComponentIds.Bounds);
            component.bounds = newBounds;

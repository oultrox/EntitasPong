...
namespace Entitas {
    public partial class Entity {
        public Oultrox.EntitasPong.Entitas.Components.GameState.GoalComponent goal { get { return (Oultrox.EntitasPong.Entitas.Components.GameState.GoalComponent)GetComponent(ComponentIds.Goal); } }

        public bool hasGoal { get { return HasComponent(ComponentIds.Goal); } }

        public Entity AddGoal(int newPointsPerGoal) {
            var component = CreateComponent<Oultrox.EntitasPong.Entitas.Components.GameState.GoalComponent>(ComponentIds.Goal);
    ...
    public partial class Pool {
        ...
        public Oultrox.EntitasPong.Entitas.Components.GameState.GoalComponent goal { get { return goalEntity.goal; } }

        public bool hasGoal { get { return goalEntity != null; } }

        public Entity SetGoal(int newPointsPerGoal) {
            if (hasGoal) {
                throw new EntitasException("Could not set goal!\n" + this + " already has an entity with Heizhu.EntitasPong.Entitas.Components.GameState.GoalComponent!",

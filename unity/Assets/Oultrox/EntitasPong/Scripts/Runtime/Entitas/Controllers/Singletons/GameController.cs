...
using Oultrox.Common.Entitas.Systems.Render;
using Oultrox.Common.Entitas.Systems.Transform;
using Oultrox.EntitasPong.Entitas.Systems.Collision;
using Oultrox.Common.Entitas.Systems;
...
//
using Oultrox.Common.Entitas.Systems.Destroy;
using Oultrox.Common.Singleton;
using UnityEngine.SceneManagement;
using Oultrox.Common.Entitas.Systems.GameState;
using Oultrox.EntitasPong.Entitas.Components;
using Oultrox.Common.Entitas.Controllers.Singleton;
using System.Collections;
using Oultrox.Common.Entitas.Utilities;
using EntitasSystems = Entitas.Systems;
using Oultrox.EntitasPong.Entitas.Systems.GameState;
using Oultrox.EntitasPong.Entitas.Systems;
using Oultrox.Common.Utilities;
using Oultrox.Common.Entitas.Components.Render;

namespace Oultrox.EntitasPong.Entitas.Controllers.Singleton
{
	/// <summary>
    ...
    public class GameController : SingletonMonobehavior<GameController> 
	{
        ...
        private Oultrox.Common.UnityEngineReplacement.Bounds _screenBounds;
		...
		private void SetupEntities ()
		{
          ...
          //Debug.Log(bounds.min.y + " and " + bounds.max.y);
            ...
            whitePaddleEntity.AddVelocity       (Oultrox.Common.UnityEngineReplacement.Vector3.zero);
            whitePaddleEntity.AddFriction       (Oultrox.Common.UnityEngineReplacement.Vector3.zero);
            ...
            blackPaddleEntity.AddVelocity   (Oultrox.Common.UnityEngineReplacement.Vector3.zero);
            blackPaddleEntity.AddFriction   (Oultrox.Common.UnityEngineReplacement.Vector3.zero);
        ...
        private void OnWhitePaddleComponentAdded (Entity entity, int index, IComponent component)
        {
            ...
            {
                entity.AddPosition(new Oultrox.Common.UnityEngineReplacement.Vector3(_screenBounds.max.x - entity.view.bounds.size.x / 2 - PaddleOffsetToEdgeX, 0, 0));
        ...
        private void OnBlackPaddleComponentAdded (Entity entity, int index, IComponent component) 
        {
            if (component.GetType() == typeof(ViewComponent))
            {
                entity.AddPosition (new Oultrox.Common.UnityEngineReplacement.Vector3 (_screenBounds.min.x + entity.view.bounds.size.x/2 + PaddleOffsetToEdgeX, 0, 0));
